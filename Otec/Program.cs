...
namespace Otec
{
    public class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Encargado enc = new Encargado(1, "Alexis Carrasco", "19.984.526-8", 941692191);
            Console.WriteLine("Nombre Encargado :" + enc.Nombre);
            Curso cu = new Curso(1, "Guardia");
            Console.WriteLine("Nombre curso :" + cu.Nombre);
            Asignatura a1 = new Asignatura(1, "Ingles");
            Asignatura a2 = new Asignatura(2, "Matematicas");
            Asignatura a3 = new Asignatura(3, "Leyes");
            ...
            Encargado enc2 = new Encargado(2, "Pedro Fernandez", "00.000.000-0", 900000000);
            Console.WriteLine("Nombre Encargado :" + enc2.Nombre);
            Curso cu2 = new Curso(2, "Prevencion De Riesgo");
            Console.WriteLine("Nombre curso :" + cu2.Nombre);
            Asignatura a4 = new Asignatura(4, "Aritmetica");
            Asignatura a5 = new Asignatura(5, "Calculo II");
            Asignatura a6 = new Asignatura(6, "Leyes");
            Asignatura a7 = new Asignatura(7, "Ingles I");
            ...
            Coordinador coo2 = new Coordinador(2, "Javier Zapata", "11.111.111-1", 911111111);
            ...
            Encargado enc3 = new Encargado(3, "Cristobal Colon", "22.222.222-2", 922222222);
            Console.WriteLine("Nombre Encargado :" + enc3.Nombre);
            Curso cu3 = new Curso(3, "Cajero Bancario");
            ...
            Asignatura a11 = new Asignatura(11, "Ingles I");
            ...
            Coordinador coo3 = new Coordinador(3, "bernardo O'higgins", "33.333.333-3", 933333333);
